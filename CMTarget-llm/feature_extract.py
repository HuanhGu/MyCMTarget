...
class FeatureExtractor(object):
    ...
    def pro_fea_extract(self, pro_sequence):
        ...
        for one_pro_sequence in pro_sequence:
            # [提取 1 个蛋白质序列的特征]
            model = Word2Vec.load("./word2vec_30.model")
            protein_embedding = self.get_protein_embedding(model, self.seq_to_kmers(one_pro_sequence))
